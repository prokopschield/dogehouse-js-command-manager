...
export declare type CommandListener = (message: any, argc: number, argv: string[], argt: FormattedMessageChunk[]) => void | undefined | UnformattedMessageChunk | Promise<UnformattedMessageChunk>;
